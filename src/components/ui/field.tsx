...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"gap-3 data-[slot=checkbox-group]:gap-3 [&>[data-slot=field-group]]:gap-4 group/field-group @container/field-group flex w-full flex-col",
				className,
			)}
			{...props}
		/>
...
function Field({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: generic container
		<div
			role="group"
			data-slot="field"
